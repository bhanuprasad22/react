...
function App() {
  ...
  // Run generator when options change
  useEffect(() => {
    passwordGenerator();
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 px-4">
